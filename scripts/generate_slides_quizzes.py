...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/termynal/termynal.css">
</head>
<body>
    <div class="reveal">
        <div class="slides">
    ...
    <style>
        ...
        .reveal img {{ max-height: 400px; width: auto; background: transparent !important; }}
    </style>
    ...
    <script src="https://cdn.jsdelivr.net/npm/termynal/termynal.js"></script>
    <script>
        Reveal.initialize({{
            hash: true,
            slideNumber: 'c/t',
        ...
        Reveal.on('ready', event => {{ initializePlugins(); }});
