...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.body.addEventListener("click", function (e) {
    ...
    const quizItem =
      option.closest(".quiz-item") || option.closest(".quiz-container");
    console.log("Quiz Container found:", quizItem);
    const feedbackEl = quizItem
      ? quizItem.querySelector(".quiz-feedback")
      : null;
    ...
    if (feedbackEl) {
      feedbackEl.innerHTML =
        (isCorrect
          ...
          : "<strong>Incorreto.</strong> ") + (feedbackText || "");
