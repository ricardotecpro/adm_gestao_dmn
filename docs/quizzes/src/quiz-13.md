# Quiz 13 - Recursos Essenciais

1. O que melhor define a matriz principal do tema 'Recursos Essenciais'?
...
3. Marque a alternativa que descreve a melhor adaptação tecnológica em Recursos Essenciais:
...
4. Relacionado às métricas de acompanhamento em 'Recursos Essenciais', o que devemos olhar agressivamente?
...
5. Em 'Recursos Essenciais', o termo 'Escalabilidade' se refere a:
...
6. Sobre a perenidade contínua do negócio em 'Recursos Essenciais', o ideal atestado no mercado atual aponta para:
...
7. Qual é o aspecto mais deletério ao iniciar frentes sobre 'Recursos Essenciais' num planejamento rígido tradicional?
...
8. Qual atitude corrobora sucesso para um empresário frente à restrição identificada no processo 'Recursos Essenciais'?
...
10. Qual a regra de ouro final que perpassa todo o aprendizado de 'Recursos Essenciais' atrelado na era ágil?
