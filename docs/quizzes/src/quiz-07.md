# Quiz 07 - Modelagem Canvas

1. O que melhor define a matriz principal do tema 'Modelagem Canvas'?
...
3. Marque a alternativa que descreve a melhor adaptação tecnológica em Modelagem Canvas:
...
4. Relacionado às métricas de acompanhamento em 'Modelagem Canvas', o que devemos olhar agressivamente?
...
5. Em 'Modelagem Canvas', o termo 'Escalabilidade' se refere a:
...
6. Sobre a perenidade contínua do negócio em 'Modelagem Canvas', o ideal atestado no mercado atual aponta para:
...
7. Qual é o aspecto mais deletério ao iniciar frentes sobre 'Modelagem Canvas' num planejamento rígido tradicional?
...
8. Qual atitude corrobora sucesso para um empresário frente à restrição identificada no processo 'Modelagem Canvas'?
...
10. Qual a regra de ouro final que perpassa todo o aprendizado de 'Modelagem Canvas' atrelado na era ágil?
