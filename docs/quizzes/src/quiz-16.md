# Quiz 16 - Fontes de Receita

1. O que melhor define a matriz principal do tema 'Fontes de Receita'?
...
3. Marque a alternativa que descreve a melhor adaptação tecnológica em Fontes de Receita:
...
4. Relacionado às métricas de acompanhamento em 'Fontes de Receita', o que devemos olhar agressivamente?
...
5. Em 'Fontes de Receita', o termo 'Escalabilidade' se refere a:
...
6. Sobre a perenidade contínua do negócio em 'Fontes de Receita', o ideal atestado no mercado atual aponta para:
...
7. Qual é o aspecto mais deletério ao iniciar frentes sobre 'Fontes de Receita' num planejamento rígido tradicional?
...
8. Qual atitude corrobora sucesso para um empresário frente à restrição identificada no processo 'Fontes de Receita'?
...
10. Qual a regra de ouro final que perpassa todo o aprendizado de 'Fontes de Receita' atrelado na era ágil?
