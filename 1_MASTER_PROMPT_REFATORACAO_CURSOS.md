...
1. **Mermaid.js CDNs & Macros**
   ...
   - **Prevenção de Erros ("Syntax Error"):** Em diagramas OO, relações (ex: `Pessoa <|-- Aluno`) devem ser plotadas preferencialmente após los blocos de definição das classes. Use tipagem unificada (ex: `+String nome`).
